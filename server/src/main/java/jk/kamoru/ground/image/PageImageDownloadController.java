...
public class PageImageDownloadController {
  ...
  public DownloadResult pageImageDownload(@RequestParam String pageUrl, @RequestParam String downloadDir, @RequestParam String folderName, @RequestParam String titlePrefix,
      @RequestParam String titleCssQuery, @RequestParam int minimumKbSize) {
