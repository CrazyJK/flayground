...
import '../domain/part/FlayActress';
import '../domain/part/FlayCover';
import '../domain/part/FlayOpus';
import '../domain/part/FlayRank';
import '../domain/part/FlayRelease';
import '../domain/part/FlayStudio';
import '../domain/part/FlayTag';
import '../domain/part/FlayTitle';
...
class FlayVideo extends HTMLVideoElement {
  ...
  set(opus) {
    ...
    this.loaded = false;
    this.playing = false;
    FlayFetch.getCover(opus).then((url) => (this.poster = url));
