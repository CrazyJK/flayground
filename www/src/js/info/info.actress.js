import $ from 'jquery';
import { reqParam, birthRegExp, bodyRegExp, heightRegExp, debutRegExp, Random } from '../crazy.common.js';
import { Rest } from '../flay.rest.service.js';
import { Util, Search } from '../flay.utils.js';
import { loading } from '../flay.loading.js';
import { ACTRESS, MODIFIED, RANK, COMMENT, FILEINFO } from '../flay.view.card.js';
